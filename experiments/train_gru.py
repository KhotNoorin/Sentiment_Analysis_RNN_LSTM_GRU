...
BATCH_SIZE = 64
EPOCHS = 5
MODEL_SAVE_PATH = 'checkpoints/gru_model.h5'
TOKENIZER_SAVE_PATH = 'checkpoints/gru_tokenizer.pkl'
...
model = build_gru_model(vocab_size=MAX_VOCAB, embedding_dim=EMBEDDING_DIM, input_length=MAX_LEN)
...
def plot_history(history):
    ...
    plt.tight_layout()
    plt.savefig('checkpoints/gru_training_plot.png')
    plt.show()
