...
BATCH_SIZE = 64
EPOCHS = 5
MODEL_SAVE_PATH = 'checkpoints/bilstm_model.h5'
TOKENIZER_SAVE_PATH = 'checkpoints/bilstm_tokenizer.pkl'
...
model = build_bilstm_model(vocab_size=MAX_VOCAB, embedding_dim=EMBEDDING_DIM, input_length=MAX_LEN)
...
def plot_history(history):
    ...
    plt.tight_layout()
    plt.savefig('checkpoints/bilstm_training_plot.png')
    plt.show()
